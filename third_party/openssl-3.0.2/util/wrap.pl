...
BEGIN {
    ...
    require '/home/litvinov/cpp_files/document_signer_ver_1.4/third_party/openssl-3.0.2/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/litvinov/cpp_files/document_signer_ver_1.4/third_party/openssl-3.0.2/test/fips-and-base.cnf';
    shift;
